    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-[#1a2744] flex flex-col z-50">
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-bold text-lg leading-none">TicketFLO</div>
            <div className="text-[#4db8a4] text-xs font-semibold tracking-widest uppercase mt-0.5">Training</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-white/10 hover:text-white transition"
        >
